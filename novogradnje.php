...
<table class="table table-hover" id="miza">
  ...
  <tbody>
    ...
    $query = "SELECT n.*, s.slika, k.ime AS ime_kraja FROM nepremicnine n INNER JOIN slike s ON n.id = s.nepremicnina_id INNER JOIN kraji k ON k.id = n.kraj_id WHERE n.vrsta = 'novogradnja' ORDER BY id DESC";
