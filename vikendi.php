...
<div style="display: flex; flex-direction: row; justify-content: space-between;">
  ...
  <div style="margin-right: 10%;">
    <div style="width: 80%; margin: 0 auto; margin-bottom: 20px; display: flex; flex-direction: row; justify-content: space-between">
      ...
      ?>
      <form name="sort-form" method="GET" action="vikendi.php" >
    ...
    <table class="table table-hover" id="miza">
      ...
      <tbody>
        ...
        if(!isset($_GET['sort'])) {
          $query = "SELECT n.*, k.ime AS ime_kraja FROM nepremicnine n INNER JOIN kraji k ON k.id = n.kraj_id WHERE n.vrsta = 'vikend' AND n.posredovanje LIKE ? AND n.tip LIKE ? ORDER BY id DESC";
        }
        elseif($_GET['sort'] == "price-asc") {
          $query = "SELECT n.*, k.ime AS ime_kraja FROM nepremicnine n INNER JOIN kraji k ON k.id = n.kraj_id WHERE n.vrsta = 'vikend' AND n.posredovanje LIKE ? AND n.tip LIKE ? ORDER BY n.cena";
        }
        elseif($_GET['sort'] == "price-desc") {
          $query = "SELECT n.*, k.ime AS ime_kraja FROM nepremicnine n INNER JOIN kraji k ON k.id = n.kraj_id WHERE n.vrsta = 'vikend' AND n.posredovanje LIKE ? AND n.tip LIKE ? ORDER BY n.cena DESC";
        }
        elseif($_GET['sort'] == "date") {
          $query = "SELECT n.*, k.ime AS ime_kraja FROM nepremicnine n INNER JOIN kraji k ON k.id = n.kraj_id WHERE n.vrsta = 'vikend' AND n.posredovanje LIKE ? AND n.tip LIKE ? ORDER BY id DESC";
        }
        elseif($_GET['sort'] == "m2-asc") {
          $query = "SELECT n.*, k.ime AS ime_kraja FROM nepremicnine n INNER JOIN kraji k ON k.id = n.kraj_id WHERE n.vrsta = 'vikend' AND n.posredovanje LIKE ? AND n.tip LIKE ? ORDER BY n.velikost";
        }
        elseif($_GET['sort'] == "m2-desc") {
          $query = "SELECT n.*, k.ime AS ime_kraja FROM nepremicnine n INNER JOIN kraji k ON k.id = n.kraj_id WHERE n.vrsta = 'vikend' AND n.posredovanje LIKE ? AND n.tip LIKE ? ORDER BY n.velikost DESC";
        }
        else {
          $query = "SELECT n.*, k.ime AS ime_kraja FROM nepremicnine n INNER JOIN kraji k ON k.id = n.kraj_id WHERE n.vrsta = 'vikend' AND n.posredovanje LIKE ? AND n.tip LIKE ? ORDER BY id DESC";
        }
...
$(document).ready(function() {
  ...
  $('#prodaja').click(function(){
    window.location.href = "vikendi.php?posredovanje=prodaja";
  });
  $('#nakup').click(function(){
    window.location.href = "vikendi.php?posredovanje=nakup";
  });
  $('#oddaja').click(function(){
    window.location.href = "vikendi.php?posredovanje=oddaja";
  });
  $('#najem').click(function(){
    window.location.href = "vikendi.php?posredovanje=najem";
  });
  ...
  $('#soba').click(function(){
    ...
    if(posredovanje) {
      window.location.href = "vikendi.php?posredovanje=" + posredovanjeValue + "&tip=soba";
    } else {
      window.location.href = "vikendi.php?tip=soba";
    }
  });
  $('#2-sobno').click(function(){
    ...
    if(posredovanje) {
      window.location.href = "vikendi.php?posredovanje=" + posredovanjeValue + "&tip=2-sobno";
    } else {
      window.location.href = "vikendi.php?tip=2-sobno";
    }
  });
  $('#3-sobno').click(function(){
    ...
    if(posredovanje) {
      window.location.href = "vikendi.php?posredovanje=" + posredovanjeValue + "&tip=3-sobno";
    } else {
      window.location.href = "vikendi.php?tip=3-sobno";
    }
  });
  $('#4-sobno').click(function(){
    ...
    if(posredovanje) {
      window.location.href = "vikendi.php?posredovanje=" + posredovanjeValue + "&tip=4-sobno";
    } else {
      window.location.href = "vikendi.php?tip=4-sobno";
    }
  });
  $('#5-sobno').click(function(){
    ...
    if(posredovanje) {
      window.location.href = "vikendi.php?posredovanje=" + posredovanjeValue + "&tip=5-sobno";
    } else {
      window.location.href = "vikendi.php?tip=5-sobno";
    }
  });
  $('#garsonjera').click(function(){
    ...
    if(posredovanje) {
      window.location.href = "vikendi.php?posredovanje=" + posredovanjeValue + "&tip=garsonjera";
    } else {
      window.location.href = "vikendi.php?tip=garsonjera";
    }
  });
  $('#apartma').click(function(){
    ...
    if(posredovanje) {
      window.location.href = "vikendi.php?posredovanje=" + posredovanjeValue + "&tip=apartma";
    } else {
      window.location.href = "vikendi.php?tip=apartma";
    }
  });
  $('#drugo').click(function(){
    ...
    if(posredovanje) {
      window.location.href = "vikendi.php?posredovanje=" + posredovanjeValue + "&tip=drugo";
    } else {
      window.location.href = "vikendi.php?tip=drugo";
    }
  });
</script>